# Try to dump function from an idb to STABS.
#
# Tavis Ormandy <taviso@gmail.com>, August 2022
#
# Note: I am not a python programmer, I usually use IDC!
...
print("# Automatically generated by idb2stabs.py")
...
while func is not None:
    ...
    # FIXME: Handle non-cdecl
    if funcdata.cc != CM_CC_CDECL:
        func = ida_funcs.get_next_func(func.start_ea)
        continue
    ...
    for arg in range(funcdata.size()):
        ...
        # Parameters can't be void, this must be a 
        # known type.
        # TODO: Get it's size and return uint_xx
        if type == "%void" and pstr == "":
            print("Unknown type %s" % str(funcdata[arg].type))
            break
